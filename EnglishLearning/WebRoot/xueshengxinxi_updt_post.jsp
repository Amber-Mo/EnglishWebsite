...
<body>
	<%
		...
		String sql="update xueshengxinxi set xuehao='"+xuehao+"',xingming='"+xingming+"',banji='"+banji+"',xingbie='"+xingbie+"',dianhua='"+dianhua+"',zhaopian='"+zhaopian+"',shenfenzheng='"+shenfenzheng+"',jiatingzhuzhi='"+jiatingzhuzhi+"',beizhu='"+beizhu+"',mima='"+mima+"' where id= "+id;
		connDbBean.executeUpdate(sql);
		out.print("<script>alert('ÐÞ¸Ä³É¹¦!!');location.href='xueshengxinxi_list.jsp';</script>");
	%>
</body>
</html>
