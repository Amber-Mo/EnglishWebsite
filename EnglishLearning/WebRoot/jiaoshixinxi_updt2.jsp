...
<body >
	<form name="form1" id="form1" method="post" action="jiaoshixinxi_updt_post2.jsp">
    修改教师信息<br><br>
	<%
   ...
   <table width="60%" border="1" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">  
	   <tr><td align="center">工号</td><td><input name='gonghao' type='text' id='gonghao' value='<%= gonghao%>' readonly="readonly" /></td></tr>
	   ...
	   <tr><td align="center">照片</td><td><input name='zhaopian' type='text' id='zhaopian' size='50' value='<%= zhaopian%>' />&nbsp;
	   <input type='button' value='上传' onClick="up('zhaopian')"/></td></tr>
	   <tr><td align="center">主教课程</td><td><select name='zhujiaokecheng' id='zhujiaokecheng'>
     <%
      ...
      <%
	    	...
	    	<script language="javascript">document.form1.zhujiaokecheng.value='<%=zhujiaokecheng%>';</script>
